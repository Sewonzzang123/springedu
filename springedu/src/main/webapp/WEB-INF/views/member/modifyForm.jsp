...
<link rel="stylesheet" href="${contextPath }/css/member/modifyForm.css?ver=1">
			...
			<div class="content">
				<section>
					<form id="modifyForm" method="post"
						...
						<ul>
							<li><label for="file">프로필 사진</label></li>
							<li>
								<div class="mypicArea">
							...
							<li><input type="text" name="id" id="id"
								value='${sessionScope.member.id }' readonly="readonly" /></li>
							...
							<li><input type="tel" name="tel" id="tel"
								value='${sessionScope.member.tel }' /></li>
							...
							<li><select name="region" id="region">
									...
									<option value="서울"
										${sessionScope.member.region == "서울" ? 'selected="selected"' : '' }>서울</option>
									<option value="부산"
										${sessionScope.member.region == "부산" ? 'selected="selected"' : '' }>부산</option>
									<option value="대구"
										${sessionScope.member.region == "대구" ? 'selected="selected"' : '' }>대구</option>
									<option value="울산"
										${sessionScope.member.region == "울산" ? 'selected="selected"' : '' }>울산</option>
									<option value="대전"
										${sessionScope.member.region == "대전" ? 'selected="selected"' : '' }>대전</option>
							</select></li>
							<li><label for="birth">생년월일</label></li>
							<li><input type="date" name="birth" id="birth"
								value='${sessionScope.member.birth }' /></li>
							<li>&nbsp;</li>
